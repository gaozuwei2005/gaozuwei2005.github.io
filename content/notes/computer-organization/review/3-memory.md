...
toc: true
description: 存储基本概念、字扩展/位扩展、程序的局部性分析、Cache、三种映射方式、缺失类型分析、Cache 的写策略、替换策略、页表结构、页表/TLB 完整访存链路、3种hit/miss及其组合
---
...
- **存取速度**：$数据传输率（存取带宽） = 数据宽度 / 存储周期$
  ...
  ![](Pasted-image-20260103170023.png)
## 3.1.3 多层次存储系统

![](Pasted-image-20260103170953.png)
...
| 周期参数 | tRC      | tWC       |
![](Pasted-image-20260103175547.png)

![](Pasted-image-20260103175601.png)
...
- 如果有相等且有效位为 $1$，则命中
- 组相联映射的地址结构为：![](Pasted-image-20260103214524.png)
...
![](Pasted-image-20260104105705.png)
- **有效位 / Valid**：是否已经调入主存
...
![](Pasted-image-20260104130905.png)
